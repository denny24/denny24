...
function registerAccount() {
    ...
    if (regUsername && regPassword) {
        ...
        if (existingUser) {
            ...
            var popup = document.getElementById("popup");
            var popupContent = document.getElementById("popup-content");
            popupContent.innerHTML = "<h2>Akun berhasil terdaftar!</h2><p>Silakan login dengan akun baru Anda.</p><button class='close-btn' onclick='closePopupAndLogin()'>Close</button>";
...
function closePopupAndRedirect() {
    var popup = document.getElementById("popup");
    popup.style.display = "none"; // Sembunyikan pop-up saat tombol close ditekan
    window.location.href = "https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley"; // Buka halaman YouTube setelah popup ditutup
}
